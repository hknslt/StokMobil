            ...
            child: Row(
              children: [
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: tema.textTheme.bodySmall?.copyWith(
                          color: tema.textTheme.bodySmall?.color?.withOpacity(.7),
                        ),
                      ),
                    ],
                  ),
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text("Kayıtlıdan Seç",
            ...
            Padding(
              ...
              child: Card(
                ...
                child: ListTile(
                  ...
                  subtitle:
                      Text("${_secilen!.yetkili ?? '—'} • ${_secilen!.telefon ?? '—'}"),
                  trailing: IconButton(
...
class _MusteriSecBottomSheetState extends State<MusteriSecBottomSheet> {
  ...
  List<MusteriModel> _uygulanmisListe(List<MusteriModel> tum) {
    ...
    if (_harfFiltre != 'Tümü') {
      veri = veri.where((m) {
        final base = (m.firmaAdi?.trim().isNotEmpty == true
                ? m.firmaAdi!
                : (m.yetkili ?? ''))
            .trim();
